  ...
  <script src="js/script.js"></script>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            ...
            <div class="row">
                <form class="row md-5 mt-4 d-flex justify-content-center" method="POST" action="create/sell.php">
                    <div class="col-sm-6">
                        <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Nuova Vendita</h5>
                            <label for="iName">Oggetto:</label><br>
                            <input type="text" id="iname" class="form-control" name="iname"><br>
                            <label for="udate">Data Vendita:</label><br>
                            <input type="date" id="idate" class="form-control" name="idate" value=<?php echo date("Y-m-d") ?>  max='<?php echo date("Y-m-d") ?>' required><br>
                            <label for="iprice">Prezzo:</label><br>
                            <input type="number" id="iprice" class="form-control" name="iprice" ><br>
                            <select name="iid" id="iid" class="form-control form-control-lg">
                                <?php 
                                while($row = $result->fetch_assoc()) {
                                    $id=$row['ID'];
                                    $nome=$row['nome'];
                                    $cognome=$row['cognome'];
                                    echo "<option value=$id>$id,$nome, $cognome</option>";
