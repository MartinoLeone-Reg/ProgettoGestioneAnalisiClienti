            ...
            <div class="row">
                    ...
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title p-3">
                              <?php $sql ="SELECT count(*) as c FROM `clienti` WHERE 1";
                ...
                <div class="col-md-3">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title p-3">
                          <?php $sql ="SELECT count(*) as c FROM `acquisti` WHERE 1";
                                $result = $conn->query($sql);
                                while($row = $result->fetch_assoc()){
                                echo $row["c"];
                                }
                ...
                <div class="col-md-3">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title p-3">
                            <?php $sql ="SELECT sum(prezzo) as c FROM `acquisti` WHERE 1";
                                    $result = $conn->query($sql);
                                    while($row = $result->fetch_assoc()){
                                    echo $row["c"];
                                    }
                ...
                <div class="col-md-3">
                    <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title p-3">
                                <?php $sql ="SELECT count(*) as c FROM `operatori` WHERE 1";
                                        $result = $conn->query($sql);
                                        while($row = $result->fetch_assoc()){
                                        echo $row["c"];
                                        }
